...
func newAuthenticatedClient(t *testing.T) *Client {
	...
	_, err := client.AuthPartnerLogin(t.Context())
	if err != nil {
	...
	_, err = client.AuthUserLogin(t.Context(), username, password)
	if err != nil {
...
func Test_AuthPartnerLogin_1(t *testing.T) {
	client := newClient(t)
	response, err := client.AuthPartnerLogin(t.Context())
	if err != nil {
...
func Test_AuthUserLogin_1(t *testing.T) {
	...
	response, err := client.AuthUserLogin(t.Context(), username, password)
	if err != nil {
...
func Test_UserCanSubscribe_1(t *testing.T) {
	...
	response, err := client.UserCanSubscribe(t.Context())
	if err != nil {
...
func Test_UserGetBookmarks_1(t *testing.T) {
	client := newAuthenticatedClient(t)
	response, err := client.UserGetBookmarks(t.Context())
	if err != nil {
...
func Test_UserGetStationList_1(t *testing.T) {
	client := newAuthenticatedClient(t)
	response, err := client.UserGetStationList(t.Context(), true)
	if err != nil {
...
func Test_UserGetStationListChecksum_1(t *testing.T) {
	client := newAuthenticatedClient(t)
	response, err := client.UserGetStationListChecksum(t.Context())
	if err != nil {
